...
public class FtpService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        rootPath = Environment.getExternalStorageDirectory().getAbsolutePath()+"/LouShao";
        try {
            init();
            //Toast.makeText(this, "启动ftp服务成功", ShowToast.LENGTH_SHORT).show();
    ...
    public void onDestroy() {
        super.onDestroy();
        release();
        //Toast.makeText(this, "关闭ftp服务", ShowToast.LENGTH_SHORT).show();
    }
